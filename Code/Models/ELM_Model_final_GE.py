...
from utils import preprocessing_data, prepare_direct_data, prepare_forecast_data, calculate_weights, calculate_metrics
...
model_save_dir = r"C:\Users\NVN\Master_Thesis\Models\Iori\ELM"
...
for idx, forecast_horizon in enumerate(forecast_horizons, 1):
    ...
    try:
        ...
        hidden_size = 9  # Number of hidden neurons
